...
public static class SCR_UIConstants
{
	...
	/* Attributes. */
	private static Vector2 LEFT_OF_SCREEN = new Vector2(Screen.width * 0.5f * 0.25f, Screen.height * 0.5f);
	private static Vector2 RIGHT_OF_SCREEN = new Vector2(Screen.width * 0.75f, Screen.height * 0.5f);
